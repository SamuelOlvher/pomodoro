//Estilos
document.body.style.backgroundImage='url(public/backgrounds/' + Math.floor((Math.random() * 37) + 1) + '.webp)';
...
function tamanioPanels(tamanio="ampliar"){
    switch(tamanio){
        case "ampliado":
...
if(screen.width > 719){
    botonAmpliar=document.getElementById("botonAmpliar");
    ...
    <select id="tamPanels">
        ...
        <button class="botonAmpliar" onclick="tamanioPanels(document.getElementById('tamPanels').value)">Aplicar</button>`;
    botonAmpliar.innerHTML=esqueleto;
}
